...
WebUI.callTestCase(findTestCase('Blocks/Make Appointment'), [('facility') : 'Tokyo CURA Healthcare Center', ('applyReadmission') : false
        , ('healthcareProgram') : 'None', ('visitDate') : '26/10/2024', ('comment') : 'TEGUH ARDAMA'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Navbar/i_Navbar'))

WebUI.click(findTestObject('Navbar/a_History'))

WebUI.callTestCase(findTestCase('Blocks/History'), [('facility') : 'Tokyo CURA Healthcare Center', ('applyReadmission') : 'TRUE'
        , ('healthProgram') : 'None', ('visitDate') : '26/10/2024', ('comment') : 'TEGUH ARDAMA'], FailureHandling.STOP_ON_FAILURE)

...
WebUI.callTestCase(findTestCase('Blocks/Logout (Navbar)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Blocks/Logout (Profile)'), [:], FailureHandling.STOP_ON_FAILURE)

...
WebUI.verifyElementVisible(findTestObject('Profile/h2_Profile'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Profile/p_Under construction'))

WebUI.verifyElementVisible(findTestObject('Profile/a_Logout'))
